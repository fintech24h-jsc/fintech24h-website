...
export const featuredDealMakers: DealMakerProfile[] = [
  {
    ...
    about:
      'Sample profile: RWA tokenization infrastructure startup, focused on enterprise onboarding across Vietnam and Singapore.',
  ...
  },
  {
    ...
    about:
      'Sample profile: early-stage fund prioritizing strong technical teams with regionally scalable problems.',
  ...
  },
  {
    ...
    about:
      'Sample profile: quality-first exchange supporting projects preparing for listing and liquidity expansion.',
  ...
  },
  {
    ...
    about:
      'Sample profile: blockchain infrastructure provider offering node, RPC, and developer tooling solutions.',
...
export const directoryProfiles: DirectoryProfile[] = [
  {
    ...
    tags: ['RWA', 'SEA'],
    sponsored: true,
    about: 'Sample profile: real-world-asset tokenization infrastructure.',
  ...
  },
  {
    ...
    sponsored: true,
    about: 'Sample profile: Web3 game studio with an existing player community.',
  ...
  },
  {
    ...
    tags: ['Growth', 'SEA'],
    sponsored: true,
    about: 'Sample profile: growth network helping Web3 companies scale community.',
  ...
  },
  {
    ...
    sponsored: false,
    about: 'Sample profile: early-stage venture fund.',
  ...
  },
  {
    ...
    tags: ['Listing', 'Global'],
    sponsored: false,
    about: 'Sample profile: quality-first exchange.',
  ...
  },
  {
    ...
    sponsored: false,
    about: 'Sample profile: blockchain infrastructure provider.',
  ...
  },
  {
    ...
    tags: ['Fintech', 'SEA'],
    sponsored: false,
    about: 'Sample profile: cross-border payments fintech.',
  ...
  },
  {
    ...
    tags: ['Security', 'APAC'],
    sponsored: false,
    about: 'Sample profile: security, audit, and compliance solutions.',
  ...
  },
  {
    ...
    tags: ['Product', 'Web3'],
    sponsored: false,
    about: 'Sample profile: product studio for Web3 teams.',
  ...
  },
  {
    ...
    sponsored: false,
    about: 'Sample profile: builder-focused community.',
