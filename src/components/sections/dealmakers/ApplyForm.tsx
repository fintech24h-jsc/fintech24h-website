...
export default function ApplyForm({ locale = 'en' }: Props) {
  ...
  const copy = locale === 'ar' ? {
    ...
    title: '申请加入 F-Matching Season 3',
    subtitle: '填写基本信息，我们会跟进核实你的档案并推荐合适的套餐。',
    ...
    linkedinPlaceholder: 'linkedin.com/in/...',
    interestedIn: '我感兴趣的是 *',
    dealSignal: '交易信号：我们提供 / 我们寻求',
    weOffer: '我们提供',
    weAreLookingFor: '我们寻求',
    additionalNotes: '补充说明',
    additionalNotesPlaceholder: '分享更多背景信息、交易目标……',
    privacyNote: '你的信息仅用于审核 / 就 F-Matching Season 3 与你联系，未经同意不会公开。参见我们的',
    privacyPolicy: '隐私政策',
    ...
    successTitle: '申请已提交！',
    successBody: 'Fintech24h 团队将跟进确认后续步骤。',
    close: '关闭',
    contextNote: '有意向联系',
  } : {
