...
export default function CampaignCalculator() {
  ...
  return (
    <div className="max-w-2xl mx-auto w-full">
      <div className="card-default p-5 sm:p-8 space-y-6 relative overflow-hidden backdrop-blur-xl">
        ...
        <div className="border-b border-white/5 pb-4">
          ...
          <p className="text-xs text-[var(--text-secondary)] font-body">
            Build your marketing setup to claim a custom execution blueprint.
          </p>
        </div>
          ...
          <form onSubmit={handleFormSubmit} className="space-y-6">
            ...
            <div className="space-y-3">
              ...
              <div className="border border-white/5 rounded-2xl overflow-hidden bg-white/[0.01]">
                ...
                >
                  <div>
                    <span className="font-mono text-[9px] text-[var(--accent-cyan)] uppercase tracking-wider block mb-0.5">Step 01 / Specifications</span>
                    <span className="text-xs sm:text-sm font-semibold text-white">
                      {projectType === 'Other' && customProjectType ? customProjectType : projectType} in {region === 'Other' && customRegion ? customRegion : region}
                    </span>
                  </div>
                ...
                {expandedSection === 'specs' && (
                  <div className="px-5 pb-5 pt-2 border-t border-white/5 space-y-4 animate-[fadeIn_0.2s_ease-out]">
                    ...
                    {/* Project Sector */}
                    <div>
                      <label className="block text-[10px] text-[var(--text-secondary)] font-mono uppercase tracking-wider mb-2">Project Sector</label>
              ...
              <div className="border border-white/5 rounded-2xl overflow-hidden bg-white/[0.01]">
                ...
                >
                  <div>
                    <span className="font-mono text-[9px] text-[var(--accent-purple)] uppercase tracking-wider block mb-0.5">Step 02 / Services &amp; Tactics</span>
                    <span className="text-xs sm:text-sm font-semibold text-white">
                      Selected {selectedServices.length} Growth Tactics
                    </span>
                  </div>
              ...
              <div className="border border-white/5 rounded-2xl overflow-hidden bg-white/[0.01]">
                ...
                >
                  <div>
                    <span className="font-mono text-[9px] text-[#f0a278] uppercase tracking-wider block mb-0.5">Step 03 / Monthly Growth Budget</span>
                    <span className="text-xs sm:text-sm font-semibold text-white">
            ...
            {/* Contact Information Fields (Always visible for easy conversion) */}
            <div className="space-y-3 pt-2 border-t border-white/5">
              <span className="font-mono text-[9px] text-[var(--text-secondary)] uppercase tracking-wider block mb-1">Step 04 / Contact details</span>
