# AGENTS.md — Fintech24h Project Intelligence

> **Đây là file bắt buộc đọc đầu tiên.** Codex PHẢI đọc file này trước khi chạm vào bất kỳ file nào trong dự án. Mọi quyết định kỹ thuật và thiết kế phải tuân theo tài liệu này.
...
Trước khi báo cáo task hoàn thành, Codex phải tự hỏi:
